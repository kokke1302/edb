...
import 'package:edb/wordbook/presentation/list/card.dart';
...
import 'package:edb/wordbook/presentation/search/sort_order.dart';
...
class WordbookScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget showCards({required WordListState state}) {
      final wordEntries = state.words;
        ...
        mainContentSliver = SliverList(
          delegate: SliverChildBuilderDelegate(
            ...
            (context, index) {
              ...
              return MyWordCard(card: wordEntries[index]);
            },
          ),
        );
      }
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            actions: <Widget>[
              ...
              IconButton(
                onPressed: () => {
                  ref.invalidate(sortSettingProvider),
                  ref.invalidate(wordListProvider),
                },
                icon: const Icon(Icons.home),
              ),
              IconButton(
                onPressed: () => ref.read(wordListProvider.notifier).reload(),
